...
### How to reach me: 
 ...
 - telegam - [@MultsVit](https://t.me/MultsVit) 
 - email - irk.matyko.v@gmail.com
 - instagram - [vitaliy_matyko](https://instagram.com/vitaliy_matyko)

Techonologies | Description | Tools
--- | --- | ---
Javascript | *methodology* | **MVC**, **DOM**, **TDD**, **AJAX**, **SOLID**, **OOP**
React | *services* | `React router DOM v6`, `Redux`, `React Hooks`
Testing | *test* | `Jest`
